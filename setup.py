...
setup(name='word2veckeras',
      ...
      url='hhttps://github.com/niitsuma/word2vec-keras-in-gensim',
      download_url='httphttps://github.com/niitsuma/word2vec-keras-in-gensim/archive/master.zip',
      license='GNU Affero General Public License, version 3 - http://www.gnu.org/licenses/agpl-3.0.html',
      #install_requires=['gensim','keras','theano', 'pyyaml', 'six'],
